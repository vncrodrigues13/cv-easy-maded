---
name: dev
description: Implement approved feature specifications from *.feature.md files by following TODO checklists in order, asking for clarification instead of assuming missing requirements.
---
