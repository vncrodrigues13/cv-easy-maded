---
description: Defines QA coverage for features by producing TDD unit/integration test scenarios and BDD acceptance scenarios with line and branch coverage expectations.
mode: subagent
permission:
  edit: deny
  bash: ask
